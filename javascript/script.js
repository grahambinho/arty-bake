...
function goShopping(){
	...
	for (let i=0; i<displaylist.length;i++){
		...
		node.children[0].children[1].children[0].innerHTML = displaylist[i].name;
		node.children[0].children[0].children[0].src = displaylist[i].objimage;
		node.children[0].children[1].children[1].innerHTML = displaylist[i].objtext;
		node.children[0].children[3].children[2].innerHTML = "\u20AC"+displaylist[i].price+".00";
		...
		node.children[0].children[3].appendChild(t);
		node.children[0].children[3].appendChild(u);
		node.children[0].children[3].appendChild(s);
...
function showBasket(){
	...
	for(let i=0; i<basketList.length; i++){
		msg+=basketList[i].name+" = "+basketList[i].quantity+" x \u20AC"+basketList[i].price+".00\n";
